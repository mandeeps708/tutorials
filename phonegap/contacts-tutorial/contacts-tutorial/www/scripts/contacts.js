...
/* 
========================================================================
This was part of the previous tutorial which has been modified
There was no explanation in the book as to why it was changed
========================================================================
function onViewLoad {
	get the contact by displayname from the URL
	var fields = ["id". "displayName", "name"
"emails", "phoneNumbers"];
...
/* used to block a bug form above */
...
(aName == bName ? 0 : 1);
	...
	for (var i = 0; i < contacts.length; i++) {
		...
		// check to see if we need to add a divider
